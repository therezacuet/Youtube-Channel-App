...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    CheckBox fullscreenOnRotate, stopNotPlaying, floating_vid;
   ...
   public Boolean b=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floating_vid= (CheckBox) findViewById(R.id.floating_video);
        ...
        floating_vid.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.video_quality:
                ...
                break;
            /*case R.id.about:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/FloatingTubeApp/"));
