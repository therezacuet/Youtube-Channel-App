...
import com.ins.floating.GetPermissionActivity;
import com.ins.floating.MainActivity;
import com.ins.floating.R;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class PlayerYouTubeView extends Activity{//extends YouTubeFailureRecoveryActivity {
        ...
        if(intent.getData() != null || intent.getStringExtra("android.intent.extra.TEXT") != null) {
            ...
            if(pId != null || vId.length() > 1) {
                if (isServiceRunning(YouTubePlayerService.class)) {
                    ...
                    YouTubePlayerService.startVid(vId, pId);
                    finish();
                } else {
